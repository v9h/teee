...
local decrypt = (syn and syn.crypt and syn.crypt.decrypt) or (crypt and crypt.decrypt) or tostring
local encrypt = (syn and syn.crypt and syn.crypt.encrypt) or (crypt and crypt.encrypt) or tostring
